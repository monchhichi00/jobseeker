...
<body class="bg-gray-50 text-gray-900 font-sans">
    ...
    <section class="bg-gradient-to-br from-blue-50 to-indigo-100 py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 class="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Add Education Details</h1>
            <p class="text-xl text-gray-600">Enhance your profile with your educational background</p>
        </div>
    </section>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                <div class="px-8 py-6 bg-gradient-to-r from-primary to-primary-light">
                    <h2 class="text-2xl font-bold text-white">Education Information</h2>
                    <p class="text-blue-100 mt-1">Please fill in your educational details below</p>
                </div>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <ul class="text-blue-800 space-y-1">
                            ...
                            <li>• Be accurate with graduation years and GPA</li>
                            <li>• Mention any relevant honors or awards</li>
